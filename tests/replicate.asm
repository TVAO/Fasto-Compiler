...
# was:	ori	_size_reg_7_, $0, 7
	bgez	$2, _safe_lab_12_
# was:	bgez	_size_reg_7_, _safe_lab_12_
	ori	$5, $0, 4
# was:	ori	$5, $0, 4
...
_loop_beg_13_:
	sub	$4, $5, $2
# was:	sub	_tmp_reg_11_, _i_reg_10_, _size_reg_7_
	bgez	$4, _loop_end_14_
# was:	bgez	_tmp_reg_11_, _loop_end_14_
	sb	$7, 0($6)
# was:	sb	_a_reg_8_, 0(_addr_reg_9_)
	addi	$6, $6, 1
